...
class AdditionalArguments():
    ...
    ex_cate: str = field(default="test", metadata={"help": "categories : train or fine tune"})
    ...
    do_adapter: bool = field(default=False, metadata={"help": "Align layer output through distillation"})
